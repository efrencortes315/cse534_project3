...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        quaggaHosts = []
        quaggaHosts.append(QuaggaHost(name='r1', ip='172.0.1.5/16',
                                      loIP='10.0.1.1/24'))
        quaggaHosts.append(QuaggaHost(name='r2', ip='172.0.2.1/16',
                                      loIP='10.0.2.1/24'))
        quaggaHosts.append(QuaggaHost(name='r3', ip='172.0.3.2/16',
                                      loIP='10.0.3.1/24'))
        quaggaHosts.append(QuaggaHost(name='r4', ip='172.0.3.1/16',
                                      loIP='10.0.3.1/24'))
        quaggaHosts.append(QuaggaHost(name='h1', ip='172.0.4.1/16',
                                      loIP='10.0.4.1/24'))
        quaggaHosts.append(QuaggaHost(name='h2', ip='172.0.254.254/16',
                                      loIP=None))
